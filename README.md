...
| 기간 | 프로젝트명 | 역할 | 성과 |
| :---: | :---: | :---: | :---: |
| 2025.03<br>~<br> 진행 중 | 랜섬웨어 대응 FUSE 파일시스템 개발(C, FUSE) | • 파일시스템 아키텍처 설계<br>- unlink, read 콜백 구현<br>• 로그 기능 구현 | • 파일 삭제 요청의 rate-limit 설계로 오탐률 감소<br>• 미허가된 파일 읽기 요청 시 FAKE_DATA 반환으로 정보 유출 방지<br>• 멀티스레드 로그 관리 모듈 구현으로 실시간 이벤트 처리 성능 향상 |
| 기간 | 이름 | 역할 | 성과 | 
| 기간 | 이름 | 역할 | 성과 |
